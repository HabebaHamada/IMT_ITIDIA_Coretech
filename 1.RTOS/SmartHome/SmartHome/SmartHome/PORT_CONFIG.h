...
#define PORTB_PIN6_INITVAL      INIT_LOW
#define PORTB_PIN7_INITVAL      INIT_LOW
							
#define PORTC_PIN0_INITVAL      INIT_LOW
#define PORTC_PIN1_INITVAL      INIT_LOW
#define PORTC_PIN2_INITVAL      INIT_LOW
#define PORTC_PIN3_INITVAL      INIT_LOW
#define PORTC_PIN4_INITVAL      INIT_LOW
#define PORTC_PIN5_INITVAL      INIT_LOW
#define PORTC_PIN6_INITVAL      INIT_LOW
#define PORTC_PIN7_INITVAL      INIT_LOW
...
#define PORTD_PIN6_INITVAL      INIT_LOW
#define PORTD_PIN7_INITVAL      INIT_LOW
#endif